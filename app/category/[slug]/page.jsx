    ...
    <>
      ...
      <ProductModal
        ...
        onAddToCart={(prod, qty, option) => {
          // Here you can add your cart store logic (or call a prop function)
          // For example: useCartStore.getState().addItem({ ...prod, quantity: qty, option });
          // For now, we'll just log the details:
          console.log("Add to Cart:", prod, qty, option);
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {combinedProducts.map((product) => (
                <div
                  ...
                  // Clicking the card opens the modal overlay
                  onClick={() => setSelectedProduct(product)}
                >
                  <Link
                    href={`/products/${product.slug}`}
                    onClick={(e) => e.preventDefault()} // Prevent navigation when modal should open
