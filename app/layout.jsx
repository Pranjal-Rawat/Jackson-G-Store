...
export const metadata = {
  ...
  other: {
    'ld+json': JSON.stringify({
      ...
      sameAs: [
        siteUrl,
        // Add Instagram, Facebook, LinkedIn URLs here
      ],
    }),
  },
};
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className="bg-white w-full overflow-x-hidden">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased bg-white text-gray-900 w-full min-w-0 overflow-x-hidden`}
