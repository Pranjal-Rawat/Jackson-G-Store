...
export default function BusinessInfo() {
  return (
    ...
    >
      ...
      <meta
        itemProp="image"
        content="https://res.cloudinary.com/dy1uhnjnq/image/upload/v1749755125/Jackson_Logo_page-0001-removebg-preview_yqeopv.png"
      />
      ...
      >
        ...
        <div className="flex items-center gap-2 justify-center">
          ...
          <span>
            Open: <span itemProp="openingHours">8am – 10pm, 7 days a week</span>
          </span>
        </div>
      </div>
