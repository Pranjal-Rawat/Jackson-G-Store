...
export default function ContactForm() {
  ...
  return (
    <section className="max-w-xl mx-auto my-12 px-4">
      <h1 className="text-3xl font-bold text-[#ed3237] mb-3 text-center">
      ...
      >
        ...
        <div className="text-xs text-gray-400 mt-2 text-center">
          ...
          For urgent support, call <a href="tel:+917417229660" className="underline text-[#ed3237]">+91 74172 29660</a>.
        </div>
      </form>
    </section>
  );
